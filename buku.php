                    ...
                    <div class="relative bg-white rounded-lg shadow ">
                        ...
                        <div class="px-6 py-6 lg:px-8">
                            ...
                            <form class="space-y-3" action="./controller/buku.php" method="POST">
                                ...
                                <div class="relative">
                                    <input type="text" id="penulis" name="penulis" class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none  focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " />
